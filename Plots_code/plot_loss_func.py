...
plt.figure(1)
plt.plot(epoch_count, total_loss_train[0].T,'r-', label='Cross Entropy')
plt.plot(epoch_count, total_loss_train[1].T,'b-', label='Squared Error')
plt.legend(bbox_to_anchor=(1.05, 1), loc=4, borderaxespad=0.)
plt.xlabel('epochs',  fontsize=25)
plt.ylabel('Training Loss',  fontsize=25)
plt.title('The Plot for training loss with different Variants of Loss Function',  fontsize=25)
...
plt.figure(2)
plt.plot(epoch_count, total_loss_val[0].T,'r-', label='Cross Entropy')
plt.plot(epoch_count, total_loss_val[1].T,'b-', label='Squared Error')
plt.legend(bbox_to_anchor=(1.05, 1), loc=4, borderaxespad=0.)
plt.xlabel('epochs',  fontsize=25)
plt.ylabel('Validation Loss',  fontsize=25)
plt.title('The Plot for validation loss with different Variants of Loss Function',  fontsize=24)

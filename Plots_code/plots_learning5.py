...
total_loss_train[0], total_loss_val[0], train_weights, train_biases = gd.gradientDescent(train_input, train_label,
...
total_loss_train[1], total_loss_val[1], train_weights, train_biases = mom.momentum(train_input, train_label,
                                                                                       val_input, val_label, layers,
                                                                                       biases, weights, activation,
                                                                                       batch_size,
                                                                                       loss,
...
total_loss_train[2], total_loss_val[2], train_weights, train_biases = nag.nag(train_input, train_label,
                                                                                       val_input, val_label, layers,
                                                                                       biases, weights, activation,
                                                                                       batch_size,
                                                                                       loss,
...
total_loss_train[3], total_loss_val[3], train_weights, train_biases = gd.gradientDescent(train_input, train_label,
                                                                                       val_input, val_label, layers,
                                                                                       biases, weights, activation,
                                                                                       batch_size,
                                                                                       loss,
...
plt.figure(1)
plt.plot(epoch_count, total_loss_train[0].T,'r-', label='Vanilla GD')
plt.plot(epoch_count, total_loss_train[1].T,'b-', label='Momentum')
plt.plot(epoch_count, total_loss_train[2].T,'g-', label='NAG')
plt.plot(epoch_count, total_loss_train[3].T,'y-', label='ADAM')
plt.legend(bbox_to_anchor=(1.05, 1), loc=4, borderaxespad=0.)
plt.xlabel('epochs',  fontsize=30)
plt.ylabel('Training Loss',  fontsize=30)
plt.title('The Plot for training loss with different Variants of GD',  fontsize=30)
...
plt.figure(2)
plt.plot(epoch_count, total_loss_val[0].T,'r-', label='Vanilla GD')
plt.plot(epoch_count, total_loss_val[1].T,'b-', label='Momentum')
plt.plot(epoch_count, total_loss_val[2].T,'g-', label='NAG')
plt.plot(epoch_count, total_loss_val[3].T,'y-', label='ADAM')
plt.legend(bbox_to_anchor=(1.05, 1), loc=4, borderaxespad=0.)
plt.xlabel('epochs',  fontsize=30)
plt.ylabel('Validation Loss',  fontsize=30)
plt.title('The Plot for validation loss with different Variants of GD',  fontsize=30)
